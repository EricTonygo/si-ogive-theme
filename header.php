                        ...
                        <form id="search_input_top_form" action="<?php echo home_url('/') ?>" method="GET">
                            <?php if (is_user_logged_in()): ?>
                                <div id="search_input_top" class="ui action input" style="width: 35em">
                                    ...
                                    <input id='s' type="text" placeholder="Rechercher dans le site ..." name="s" value="<?php
                                    if (isset($_GET['s'])) {
                                        echo stripslashes($_GET['s']);
                                    }
                                    ?>" autocomplete="off">

                                    <button id="submit_search_input_top" type="submit" class="ui yellow button"><i class="search icon"></i></button>
                                </div>
                            <?php else: ?>
                                <div id="search_input_top" class="ui action input" style="width: 35em">
...
<a href="<?php echo get_permalink(get_page_by_path(__('forums', 'si-ogivedomain'))) ?>" class="<?php if (bbp_is_forum_archive() || bbp_is_single_forum() || bbp_is_single_topic()): ?> myactive <?php endif ?> item"><?php echo get_page_by_path(__('forums', 'si-ogivedomain'))->post_title ?></a>-->
                ...
                <div class="right menu">
                    ...
                    <?php else: ?>
                                ...
                                <div class="ui fluid card" style="margin-bottom: 0;">
                                    <div class="content">
                                        <form id='login_form'  method="POST" class="ui form login_form" action="<?php echo get_permalink(get_page_by_path(__('connexion', 'si-ogivedoamin'))) ?>" style="margin-bottom: 1em" >
                                            ...
                                            <div class="field center aligned">
                                                <a href="<?php echo get_permalink(get_page_by_path(__('mot-de-passe-oublie', 'si-ogivedomain'))) ?>" style="text-transform: none;" ><?php echo __("Mot de passe oublié", "gpdealdomain"); ?> ?</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <a href="<?php echo get_permalink(get_page_by_path(__('inscription', 'si-ogivedomain'))) ?>" class="item">
                            <i class="add user icon"></i><?php echo __("S'inscrire", 'si-ogivedomain') ?>
                        </a>
                    <?php endif ?>
        ...
        <div id='sub_main_menu' class="ui fixed menu hidden">
            <div class="ui container">
                <div id='menu_grid_column_container' class="ui four column relaxed equal divided height grid">
                    <div class="column">
                    ...
                    <div class="column">
                        ...
                        <div class="ui link list">
                            ...
                            <a href="<?php echo get_permalink(get_page_by_path(__('domaines-de-competence', 'si-ogivedomain'))) ?>" class="item"> DOMAINES DE COMPETENCE</a>
                            <a href="<?php echo get_permalink(get_page_by_path(__('nous-contacter', 'si-ogivedomain'))) ?>" class="ui <?php if (is_page(__('nous-contacter', 'si-ogivedomain'))): ?> myactive <?php endif ?> item"> <?php echo get_page_by_path(__('nous-contacter', 'si-ogivedomain'))->post_title ?> </a>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        ...
                        <div class="ui link list">
                            <a href="<?php echo get_permalink(get_page_by_path(__('offres-demploi', 'si-ogivedomain'))) ?>" class="ui <?php if (is_page(__('offres-demploi', 'si-ogivedomain')) || is_category(intval(get_query_var('cat'))) || is_singular('job')): ?> myactive <?php endif ?> item"> <?php echo __("NOS OFFRES D'EMPLOI","gpdealdomain"); ?>  </a>
                            <a href="<?php echo get_permalink(get_page_by_path(__('forums', 'si-ogivedomain'))) ?>" class="<?php if (bbp_is_forum_archive() || bbp_is_single_forum() || bbp_is_single_topic()): ?> myactive <?php endif ?> item"><?php echo __("NOS FORUMS", "gpdealdomain") ?></a>
                        </div>
                    </div>
