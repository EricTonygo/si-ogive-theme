    ...
    <div class="ui stackable doubling grid">
        ...
        <div class="four wide column">
            <div class="ui fluid vertical menu moderns">
                ...
                <a href="<?php echo get_permalink(get_page_by_path(__('notre-vision', 'si-ogivedomain'))) ?>" class="<?php if(is_page(__('notre-vision', 'si-ogivedomain'))):?> header <?php endif ?> item"> <?php echo get_page_by_path(__('notre-vision', 'si-ogivedomain'))->post_title ?> </a>
                <a href="<?php echo get_permalink(get_page_by_path(__('a-propos-de-si-ogive', 'si-ogivedomain'))) ?>" class="<?php if(is_page(__('a-propos-de-si-ogive', 'si-ogivedomain'))):?> header <?php endif ?> item"> <?php echo get_page_by_path(__('a-propos-de-si-ogive', 'si-ogivedomain'))->post_title ?> </a>
                <a href="<?php echo get_permalink(get_page_by_path(__('nous-contacter', 'si-ogivedomain'))) ?>" class="item"> <?php echo get_page_by_path(__('nous-contacter', 'si-ogivedomain'))->post_title ?> </a>
            </div>
            <div class="ui fluid vertical menu moderns">
